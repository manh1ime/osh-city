    ...
    <main className="manager-theme flex min-h-screen items-center justify-center bg-[#151817] px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-wine-600">Водопад</p>
        ...
        <div className="card p-6">
          <form action="/api/auth/login" method="post" className="grid gap-4">
            ...
            <div>
              <label className="label" htmlFor="manager-email">Email</label>
              <input id="manager-email" name="email" type="email" className="input" autoComplete="username" placeholder="manager@demo.ru" required />
            </div>
            <div>
              <label className="label" htmlFor="manager-password">Пароль</label>
              <input id="manager-password" name="password" type="password" className="input" autoComplete="current-password" placeholder="••••••" required />
            </div>
