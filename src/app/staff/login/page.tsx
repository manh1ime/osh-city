        ...
        <div className="rounded-2xl bg-white p-6 shadow-card">
          <form action="/api/auth/login" method="post" className="grid gap-4">
            ...
            <div>
              ...
              <input id="staff-email" name="email" type="email" className="input" autoComplete="username" placeholder="waiter@demo.ru" required />
            </div>
            <div>
              <label className="label" htmlFor="staff-password">Пароль</label>
              <input id="staff-password" name="password" type="password" className="input" autoComplete="current-password" placeholder="••••••" required />
            </div>
